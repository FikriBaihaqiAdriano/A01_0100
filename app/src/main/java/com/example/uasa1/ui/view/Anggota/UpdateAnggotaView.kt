...
import com.example.uasa1.ui.viewmodel.UpdateAnggotaTimViewModel
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import kotlinx.coroutines.withContext

object DestinasiUpdateAnggotaTim : DestinasiNavigasi {
...
fun UpdateAnggotaScreen(
    ...
    Scaffold(
        ...
        topBar = {
            CostumeTopAppBar(
                title = DestinasiUpdateAnggotaTim.titleRes,
        ...
        AnggotaTimEntryBody(
            ...
            anggotaTimUiState = viewModel.AnggotaTimUpdateUiState,
